...
static void rep_outs_bad_rights() {
...
static int test_07b()
{
	...
	__pg_set_entry( &(pTb.ptb[0]), PG_RW, page_number((uint32_t)page_b) );		/************ Bad rights *************/
